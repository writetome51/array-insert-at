...
var insertAt_1 = require("./insertAt");
var arr = [1, 2, 3, 4];
// Test 1: make sure anything other than integer as first argument will trigger error:
var errorsTriggered = 0;
try {
    insertAt_1.insertAt(Infinity, [], arr);
}
catch (e) {
    ++errorsTriggered;
}
try {
    insertAt_1.insertAt(1.1, [], arr);
}
catch (e) {
    ++errorsTriggered;
}
try {
    insertAt_1.insertAt('1', [], arr);
}
catch (e) {
    ++errorsTriggered;
}
try {
    insertAt_1.insertAt(NaN, [], arr);
}
catch (e) {
    ++errorsTriggered;
}
try {
    insertAt_1.insertAt(true, [], arr);
}
catch (e) {
    ++errorsTriggered;
}
try {
    insertAt_1.insertAt({}, [10], arr);
}
catch (e) {
    ++errorsTriggered;
}
...
arr = [1, 2, 3, 4];
insertAt_1.insertAt(0, [7, 8], arr);
if (arr.length === 6 && arr[0] === 7 && arr[1] === 8)
...
arr = [1, 2, 3, 4];
insertAt_1.insertAt(-1, [90, 91], arr);
...
arr = [1, 2, 3, 4];
insertAt_1.insertAt(-4, [90, 91], arr);
...
try {
    insertAt_1.insertAt(-currentLength - 1, [99], arr);
}
catch (e) {
    ++errorsTriggered;
}
try {
    insertAt_1.insertAt(currentLength, [99], arr);
}
catch (e) {
    ++errorsTriggered;
}
...
errorsTriggered = 0;
try {
    insertAt_1.insertAt(1, 'hello', arr);
}
catch (e) {
    ++errorsTriggered;
}
...
try {
    insertAt_1.insertAt(1, true, arr);
}
catch (e) {
    ++errorsTriggered;
}
...
try {
    insertAt_1.insertAt(1, function () { return 1; }, arr);
}
catch (e) {
    ++errorsTriggered;
}
...
errorsTriggered = 0;
try {
    insertAt_1.insertAt(1, [1], 'hello');
}
catch (e) {
    ++errorsTriggered;
}
try {
    insertAt_1.insertAt(1, [1], '');
}
catch (e) {
    ++errorsTriggered;
}
...
try {
    insertAt_1.insertAt(1, [1], true);
}
catch (e) {
    ++errorsTriggered;
}
try {
    insertAt_1.insertAt(1, [1], 1);
}
catch (e) {
    ++errorsTriggered;
}
try {
    insertAt_1.insertAt(1, [1], function () { return 1; });
}
catch (e) {
    ++errorsTriggered;
}
